...
private:
  ...
  std::vector<double> hw_positions_states_;
  std::vector<double> hw_velocities_states_;
  std::vector<double> hw_efforts_states_;
  ...
  std::vector<double> tp1_;
  std::vector<double> tp2_;
};
